  ...
  return (
    <footer className="border-t border-card-border bg-background">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <ul className="mt-3 space-y-2">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-foreground/85 transition-colors hover:text-neon-cyan"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-10 border-t border-card-border pt-8 text-center text-xs text-foreground/65">
